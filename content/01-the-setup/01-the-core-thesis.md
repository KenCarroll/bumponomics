...
$$Progress = ƒ(Place, Participants, Problems)$$
...
$$Participants + Problems = Progress$$
...
### The Existential Map ($Who + How = Why$)

We map the tactical variables to their existential counterparts to understand the "Soul" of the organization.

$$\text{Who (Humans)} + \text{How (Organize \& Act)} = \text{Why (Survive \& Thrive)}$$

1.  **The Legacy Equation:** $How = Why - Who$
    * *Meaning:* The "How" (Institutions) is what remains of the Thriving ($Why$) after the specific People ($Who$) are gone. True leadership builds a system that outlives the leader.
2.  **The Entitlement Equation:** $Who = Why - How$
    * *Meaning:* A group of People ($Who$) who want to Thrive ($Why$) without the Struggle ($How$). This is the definition of Dependency.
...
1.  **GMP (Gross Meaningful Problems) — *Measuring Ambition*:** Are we allocating resources to existential opportunities or misplaced trivialities?
2.  **GPO (Gross Positive Outcomes) — *Measuring Efficacy*:** Did our transformations actually advance the problem state without creating negative displacement elsewhere in the system?
3.  **GIVE (Gross Increased Variety of Environment) — *Measuring Legacy*:** Did we expand the "library of parts" and increase future evolutionary potential?
