---
id: 991102b7-b00f-4bf1-8601-b544e7f1ecc1
...
There are a specific set of constraints that underpin our understanding of reality within the BUMPS ecosystem. To utilize this framework, we must agree on the boundaries of the board we are playing on.
...
1. **Progress is a vector**, not a destination. It requires both Direction and Magnitude.
2. ***f()*** is a non-linear function.
3. **Planet** represents the absolute constraints of the environment (Space).
4. **People** represents a subset of the participants in the space. *(Note: When using this formula, 'participants' can encompass non-human or non-individual entities).*
5. **Problems** are the anomalies in the space that the participants experience.
