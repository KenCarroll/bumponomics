...
description: "How we decide to organize and act, based on the problems we think we need to address, to meet the outcomes we want to achieve, within the possibilities afforded to us in a complex, dynamic environment."
order: 3
status: draft
---
...
1. **[Strategic Forecasting](https://en.wikipedia.org/wiki/Forecasting):** 
...
2. **[Scenario Planning (The Shell Model)](https://en.wikipedia.org/wiki/Scenario_planning):** 
...
7. **[Interactive Planning & Idealized Design](https://en.wikipedia.org/wiki/Interactive_planning):** 
   ...
   - *Why it is a viable option:* It encourages you to really think about what you want to achieve and to build the outcome *first*. Idealized Design is the critical target-setting phase of the broader [Interactive Planning](https://ackoffcenter.blogs.com/ackoff_center_weblog/2008/11/interactive-planning.html) framework.
...
Because this is our target outcome, the choice that seems a good fit for our needs is an active exercise in **Interactive Planning**—specifically leveraging its core phase, **[Idealized Design](https://en.wikipedia.org/wiki/Idealized_design)**—directly applying the pioneering systems thinking methodologies of [Russell Ackoff](https://en.wikipedia.org/wiki/Russell_L._Ackoff).
