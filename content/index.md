...
features:
  - title: '<span style="display:inline-flex; align-items:center; gap:12px;"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="var(--vp-c-brand)" d="M12,4A4,4 0 0,1 16,8A4,4 0 0,1 12,12A4,4 0 0,1 8,8A4,4 0 0,1 12,4M12,14C16.42,14 20,15.79 20,18V20H4V18C4,15.79 7.58,14 12,14Z" /></svg>Individuals</span>'
    details: "Critical to our success is to be able to transform our problems into positive progress. Individual micro actions create macro movements. Economic and political transformations are the result of our collective micro movements."
  - title: '<span style="display:inline-flex; align-items:center; gap:12px;"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="var(--vp-c-brand)" d="M18,15H16V17H18M18,11H16V13H18M20,19H12V17H14V15H12V13H14V11H12V9H14V7H12V5H14V3H20V19M10,19H2V3H10V19M8,5H4V7H8V5M8,9H4V11H8V9M8,13H4V15H8V13M8,17H4V19H8V17Z" /></svg>Organisations</span>'
    details: "Humans organise around problems. How we organise depends upon the situations. Harnessing organisational power is critical to coherence and collective identity. Organisations power our progress beyond individual agency. "
  - title: '<span style="display:inline-flex; align-items:center; gap:12px;"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="var(--vp-c-brand)" d="M17.9,17.39C17.64,16.59 16.89,16 16,16H15V13A1,1 0 0,0 14,12H8V10H10A1,1 0 0,0 11,9V7H13A2,2 0 0,0 15,5V4.59C17.93,5.77 20,8.64 20,12C20,14.08 19.2,15.97 17.9,17.39M11,19.93C7.05,19.43 4,16.05 4,12C4,11.38 4.08,10.78 4.21,10.21L9,15V16A2,2 0 0,0 11,18M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z" /></svg>Societies</span>'
    details: "Our collective security and wellbeing is bounded by the highest level of organisation...the society level. These define our collective economic and political movements based on problems in our collective spaces."
---
...
By entering the BUMPS ecosystem, you are not just examining the limitations of our current economic models—you are looking beyond them toward an entirely new horizon. You are being equipped with a dynamic strategic architecture to build exactly what comes next:

1. **A New Language:** You will learn a simple, practical vocabulary that cuts through drama and confusion. Instead of getting caught in subjective tension or focusing on individual shortcomings, you will learn how to map underlying structural pressures and use them as the raw fuel to elevate your capabilities.
...
## 🌐 A Universal Pattern for Progress
...
<p align="center">
  <a href="/00-preface/03-the-point-of-no-return" style="display:inline-block; padding:12px 24px; background:var(--vp-c-brand); color:white; border-radius:8px; font-weight:bold; text-decoration:none;">Enter BUMPONOMICS &rarr;</a>
</p>
